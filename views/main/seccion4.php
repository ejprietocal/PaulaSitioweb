    ...
    <div class="container seccion4">
        ...
        <div class="contenedor-para pt-5 pb-2">
            ...
            <div data-aos="fade-left" class="para-quien h-100 border border-5 rounded rounded-3 p-3 position-relative">
                ...
                <h3 class="text-center fs-1 pt-3 mt-5">Influencers</h3>
            </div>
        </div>
        <a href="https://api.whatsapp.com/send?phone=+573146929762&text=%C2%A1Hola!,%20Estoy%20interesad@%20en%20tus%20servicios!" type="button" class="button-agendar btn fs-1 mt-5 text-white p-3">Agendar una cita</a>
    </div>
</div>